...
public class XxlRpcFuture implements Future<XxlRpcResponse> {
	...
	public XxlRpcFuture(Client clientInstance, XxlRpcRequest request, XxlRpcInvokeCallback invokeCallback) {
	...
	public void setInvokerFuture(){
		this.clientInstance.setInvokerFuture(request.getRequestId(), this);
	}
	public void removeInvokerFuture(){
		this.clientInstance.removeInvokerFuture(request.getRequestId());
	}
